...
for x in range(20):
    for y in range(17):
        try1 = (int(matrix[x][y])*int(matrix[x][y+1])*int(matrix[x][y+2])*int(matrix[x][y+3]))
        if try1 > largest:
            largest = try1
...
for x in range(17):
    for y in range(17):
        try1 = (int(matrix[x][y])*int(matrix[x+1][y+1])*int(matrix[x+2][y+2])*int(matrix[x+3][y+3]))
        if try1 > largest:
            largest = try1

for x in range(17):
    for y in range(20):
        try1 = (int(matrix[x][y])*int(matrix[x+1][y])*int(matrix[x+2][y])*int(matrix[x+3][y]))
        if try1 > largest:
            largest = try1
